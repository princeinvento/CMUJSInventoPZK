<div class="col-span-10 py-7 px-10">
    <div class="articles-table">
        <div class="text-2xl font-bold mb-6">Edit Author</div>
        <hr>
        <form class="mt-5" method="POST" action="<?php echo base_url(); ?>author/edit_author/" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <select class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="role" name="role" required>
                    ...
                    <option value="3" <?php echo set_select('role', '3', $users['role'] == '3'); ?>>Evaluator</option>      
                </select>
            </div>
            <div class="mb-4">

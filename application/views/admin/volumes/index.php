<div class="col-span-10 py-7 px-10">
    <div class="articles-table">
        <div class="text-2xl font-bold mb-6">Volumes</div>
        <div class="main-actions flex mb-7 justify-between">
        <form method="GET" action="<?php echo base_url('volumes'); ?>">
            <input type="text" name="search" id="search" class="bg-gray-100 py-3 px-3 rounded w-96" placeholder="Enter a Volume" value="<?php echo isset($_GET['search']) ? $_GET['search'] : ''; ?>">
            <button type="submit" class="bg-green-900 text-white py-3 px-3 rounded">Search</button>
        </form>
        <a href="<?php echo base_url('volumes/new')?>" class="add-volume bg-green-900 text-white py-3 px-3 rounded">Create Volume</a>
        </div>
        <table class="table w-full border">
            <tr>
                <th class="py-5">Volume Name</th>
                <th class="">Status</th>
                <th>Actions</th>
            </tr>
            ...
            <tr class="border">
                ...
                <td class="border py-10">
                    <div class="px-5"><?php echo $volume['vol_name']?></div>
                </td>
                <td class="border py-10">
                    <div class="px-5">
                    <?php 
                ...
                <td>
                    <div class="actions justify-center items-center flex">
                        <a href="<?php echo base_url(); ?>volumes/view/<?php echo $volume['vol_id'];?>" class="action bg-green-900 rounded text-white p-2">
                        ...
                        <a href="<?php echo base_url(); ?>volumes/edit/<?php echo $volume['vol_id'];?>" class="action bg-green-900 rounded text-white p-2 mx-2">
                        ...
                        <a href="<?php echo base_url()?>volumes/delete/<?php echo $volume['vol_id'];?>" class="action bg-green-900 rounded text-white p-2">

        ...
        <div class="current-issue pl-12 pr-5 mt-10 border-b-2 border-gray-200">
            <div class="flex">
                <div class="flex basis-9/12 flex-col pr-8 mb-12">
                    <div class="article-title text-xl font-medium pr-2">
                    ...
                    <div class="article-info mt-5">
                        <div class="author">
                            ...
                            <?php 
                                // Loop through each author associated with the article
                                $authors = explode(',', $articles['authors']); // Assuming authors are separated by comma
                                foreach ($authors as $author) {
                                    echo trim($author) . '<br>'; // Trim to remove any extra white spaces
                                }
                            ?>
                            </p>
                        </div>
                        <div class="flex mt-3">
                            <div class="doi">
                                ...
                                <a href="<?php echo $articles['doi']; ?>" class="text-gray-600"><?php echo $articles['doi']; ?></a>
                            </div>
                            <div class="dop ml-12">
                ...
                <div class="flex basis-3/12 flex-col">
                    <img src="<?php echo base_url('assets/images/samplecover.png')?>" class=" mb-5" alt="" srcset="">

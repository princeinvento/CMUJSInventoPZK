    <div class="col-span-9">
        <div class="pl-10 pr-5 pt-10">
        <img src="<?php echo base_url('assets/images/banner.png')?>" class="w-full" alt="" srcset="">
        </div>
        <div class="current-issue pl-12 pr-5 mt-10 border-b-2 border-gray-200">
         <div class="text-xl font-medium mb-1">Current Issue</div>
         <?php if ($volumes !== false && !empty($volumes)): ?>
         ...
         <div class="current-issue-item">
            <div class="flex mt-5 mb-5">
                ...
                <div class="flex flex-col p-1 mx-auto">
                    ...
                    <a href="<?php echo base_url('current')?>" class="bg-green-800 hover:bg-green-900 text-white py-2 px-6 rounded w-100 text-center">View Volume</a>
                </div>
                <div class="flex-auto w-14 p-1 px-3">
                    <div class="item-header flex flex-row justify-between">
                        <div class="vol-name text-xl font-bold">
         ...
         <?php endforeach; ?>
         <?php else: ?>
            <p class="p-5">No released issue at the moment.</p>
        <?php endif; ?>
        </div>
        <div class="latest-articles pl-12 pr-5 mt-10">
            <div class="text-xl font-medium mb-1">Latest Articles</div>
